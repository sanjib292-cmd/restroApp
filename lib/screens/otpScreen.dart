...
import 'package:restro_app/screens/updatePassscreen.dart';
...
class _OtpState extends State<Otp> {
  ...
  Widget build(BuildContext context) {
    var verifyOtp=Provider.of<LoginRestro>(context,listen: false);
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: ButtonTheme(
                  ...
                  child: TextButton(
                    onPressed: () async {
                    await  verifyOtp.verifyOtp(widget.number, currentText);
                      if(verifyOtp.otpVarified==true){
//                         print(verifyOtp.otpVarified);
// final SharedPreferences sharedPreferences =
//                             await SharedPreferences.getInstance();
//                         sharedPreferences.setBool(
//                             'isUser', verifyOtp.otpVarified);
...
//                             'Account Details', verifyOtp.userDetails);
                        ...
                        setState(() {
                          ...
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context){
                            ...
                            child: Updatepassword(token: verifyOtp.userDetails,));
                          }));
                          // // int count = 0;
